export default function Footer() {
  return (
    <footer className="mt-16 border-t border-navy bg-navy py-8">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-3 px-4 text-center font-mono text-xs text-paper/50 md:flex-row md:justify-between sm:px-6 lg:px-8">

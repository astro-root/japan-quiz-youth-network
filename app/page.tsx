  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-16">
      <section className="grid items-center gap-12 md:grid-cols-2">
        <div>
          <p className="eyebrow mb-3">National Quiz Federation</p>
        ...
        <div className="flex justify-center">
          <svg viewBox="0 0 400 400" className="buzzer-pulse w-64 md:w-80" role="img" aria-label="早押しボタン">
            ...
            <text x="200" y="216" textAnchor="middle" fontFamily="'Zen Kaku Gothic New'" fontWeight="900" fontSize="56" fill="#FAF7EF">
              Q
            </text>
          </svg>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div>
            ...
            <p className="text-sm text-ink/70">
              学校を選んで登録するだけ。部員・部長・顧問、どの立場でも今すぐ始められます。
            </p>
          </div>
          <div>
            ...
            <p className="text-sm text-ink/70">
              部長・顧問はマイページから連盟への加盟を申請できます。審査後、正式な加盟団体として一覧に掲載されます。
            </p>
          </div>
          <div>
            ...
            <p className="text-sm text-ink/70">
              アカウントも実績も消えません。OB/OGとして緩く繋がるか、運営協力者として関わり続けられます。
            </p>
          </div>
        </div>
      </section>
